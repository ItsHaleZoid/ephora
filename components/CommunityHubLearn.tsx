...
const CommunityHubLearn = ({ communityId }: CommunityHubProps) => {
    ...
    <div className="flex flex-col h-screen overflow-hidden">  
      <div>
        <div className="flex justify-end mr-5 pl-4 ">
            <h1 className="w-200 mr-104 -mb-14 mt-6 flex justify-center h-15 text-5xl text-sky-100 bg-blue-500 rounded-full shadow-[6px_6px_0px_#000] border-2 border-black pt-0.5">Share & Learn</h1>
          <Input
            placeholder="Search"
            type="text"
...
export default CommunityHubLearn;
